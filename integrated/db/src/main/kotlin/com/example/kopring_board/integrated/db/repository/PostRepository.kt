...
interface PostRepository : JpaRepository<Post, Long?> {
    ...
    fun findByCategoryAndDeletedAtIsNotNull(category: Category) : List<Post>
    fun findByAuthorAndCategoryAndDeletedAtIsNotNull(author: User, category: Category): List<Post>
    fun findByTitleLikeAAndCategoryAndDeletedAtIsNotNull(title: String, category: Category) : List<Post>
    fun findByContentLikeAAndCategoryAndDeletedAtIsNotNull(title: String, category: Category) : List<Post>
}